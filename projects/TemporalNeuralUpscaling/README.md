...
> Status: Phases 1-3 and P4.1-P4.3 are complete. The static model lowers to one SM8550/HTP v73 FP16 `QnnBackend` delegate with no portable fallback; physical-device NPU execution remains P4.4.
