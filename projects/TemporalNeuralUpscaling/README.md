...
> Status: Phase 1 — deterministic spatial PyTorch image-inference pipeline. Temporal reconstruction, Android, ExecuTorch, QNN, and Vulkan are planned but not implemented.
