...
> Status: Phase 1 complete; Phase 2.4 static `SpatialSR2x` XNNPACK export, full delegation inspection, and runtime parity complete. Dynamic shapes, Android, QNN, Vulkan, and temporal work remain.
